...
export const ppfLines: Record<string, PpfLine> = {
  ...
  '/ppf/flow-gloss': {
    ...
    micras: 175,
    garantiaAnos: 4,
    description: 'PPF intermediário de 175 micras com 4 anos de garantia — proteção real com preço acessível.',
    faq: [
      { question: 'Qual a espessura e a garantia do NZPPF Flow Gloss?', answer: 'O Flow Gloss tem 175 micras de espessura e 4 anos de garantia registrada em apólice.' },
      { question: 'Para quem é o Flow Gloss?', answer: 'Para quem quer proteção de pintura verdadeira sem o investimento das linhas de 190 micras — ideal para carros de uso diário.' },
      { question: 'O Flow Gloss amarela com o tempo?', answer: 'Não dentro do prazo de garantia: o TPU usado resiste a UV e oxidação por 4 anos com manutenção adequada.' },
