  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.heroSection}>
        ...
        <div className={`container ${styles.heroContent}`}>
          ...
          <motion.div initial="hidden" animate="show" variants={stagger}>
            <motion.h1 className={styles.heroTitle} variants={fadeUp}>NZPPF LUXURY GLOSS</motion.h1>
            <motion.p className={styles.heroSub} variants={fadeUp}>TPU de Última Geração | + 32% Mais Brilho</motion.p>
            {showOfferBtn && (
      ...
      <section className={styles.manifestoSection}>
        <motion.div className="container" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={stagger}>
          <div className={styles.manifestoGrid}>
            <motion.div className={styles.manifestoText} variants={fadeUp}>
            ...
            <motion.div className={styles.manifestoHighlight} variants={fadeUp}>
      ...
      <section className={styles.techSection}>
        <motion.div className="container" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.25 }} variants={stagger}>
          <motion.h2 className={styles.sectionTitle} variants={fadeUp}>Arquitetura de 4 Camadas</motion.h2>
          <motion.div className={styles.techGrid} variants={fadeUp}>
            ...
            <div className={styles.techLayers}>
              {[
                ...
                <motion.div key={i} className={styles.layerCard} variants={fadeUp}>
      ...
      <section className={styles.differentialsSection}>
        <motion.div className="container" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.15 }} variants={stagger}>
          <motion.h2 className={styles.sectionTitle} variants={fadeUp}>Diferenciais Exclusivos</motion.h2>
      ...
      <section className={styles.finishesSection}>
        <motion.div className="container" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={stagger}>
          <motion.h2 className={styles.sectionTitle} variants={fadeUp}>Acabamentos Disponíveis</motion.h2>
          <motion.div className={styles.finishesShowcase} variants={fadeUp}>
